                ...
                `}
                            ...
                            <div className="p-4">
                                <div className="grid grid-cols-2 gap-2">
                                    {Array.from({length: 4}).map((_, index) => (
                                        <div key={index}
                                             className="flex items-center gap-2.5 p-2.5 rounded-lg bg-[#3a3a3c]/30 animate-pulse">
                                            ...
                                            {clients.filter(c => c.installed).map(client => (
                                                ...
                                                >
                                                    <div className="relative flex-shrink-0">
                                                        ...
                                                        {client.configExists && (
                                                            <span
                                                                className="absolute -bottom-0.5 -right-0.5 w-2.5 h-2.5 rounded-full bg-[#34c759] border-2 border-[#2c2c2e]"/>
                                                        )}
                                                    </div>
                                                    <div className="flex-1 min-w-0">
                                                        <div className="flex items-center gap-1.5">
                                                            <span
                                                                className="text-[12px] font-medium text-white truncate">{client.name}</span>
                                                        </div>
                                                        <code
                                                            className="text-[9px] text-[#636366] font-mono truncate block">
                                                ...
                                                <div className="grid grid-cols-3 gap-1.5">
                                                    {clients.filter(c => !c.installed).map(client => (
                                                        ...
                                                        >
                                                            ...
                                                            <span
                                                                className="text-[11px] text-[#636366] truncate">{client.name}</span>
                                                        </div>
                                                    ))}
                                                </div>
                                            </div>
                    ...
                    <div className="card overflow-hidden">
                        ...
                        {isInitialLoading && !runtimes ? (
                            ...
                            <>
                                <div
                                    className="flex items-center justify-between px-4 py-3 border-b border-[#3a3a3c] animate-pulse">
